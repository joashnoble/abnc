<template>
  ...
  <div>
    ...
    <div
      v-show="$refs.newspublicationentry !== undefined ? $refs.newspublicationentry.showEntry === false : true"
          ...
          <b-card class="card-accent-dark">
            <h5 slot="header">
              <span>
                ...
                <small
                  class="font-italic"
                >List of all news and publication.</small>
              </span>
              <b-button
                variant="default"
            ...
            <b-row class="mb-12">
              <b-col sm="4">
                <b-button
                  ...
                  variant="success"
                  @click="$refs.newspublicationentry.setEntry()"
                >
              ...
              <b-col sm="2">
                <div
                  style="display: inline-block!important;float:right!important; margin-top: 5px!important;"
                >
                  <b>Status:</b>
                </div>
              </b-col>
              ...
              <b-col sm="12">
                ...
                >
                  ...
                  <template v-slot:cell(news_title)="data">
                    <span
                      data-toggle="tooltip"
                      :title="data.item.news_title"
                    >{{data.item.news_title}}</span>
                  </template>
                  <template v-slot:cell(news_description)="data">
                    <span
                      data-toggle="tooltip"
                      :title="data.item.news_description"
                    >{{data.item.news_description}}</span>
                  </template>
                  ...
                  <template v-slot:cell(action)="data">
                    ...
                    <b-btn
                      v-if="checkRights('5-20')"
                      :size="'sm'"
                      variant="warning"
                      @click="$refs.archiveentry.setArchive(data.item.news_id,0)"
                    >
              ...
              <b-row>
                ...
                <b-col sm="12" class="my-1">
                  <b-pagination
                    size="sm"
                    align="right"
                    :total-rows="paginations.newspublications.totalRows"
                    :per-page="paginations.newspublications.perPage"
                    v-model="paginations.newspublications.currentPage"
                    class="my-0"
                  />
                </b-col>
              </b-row>
    ...
    <newspublicationentry type="reference" ref="newspublicationentry" />
    <DeleteEntry
      entity="newspublication"
...
export default {
  ...
  methods: {
    filterStatusList() {
      this.cmsfilterTableList(
        "newspublications",
        this.forms.newspublication.fields.status_id
      );
    }
  },
  computed: {
