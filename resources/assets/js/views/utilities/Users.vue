            ...
            <b-row>
                <b-col sm="12">
                    <b-card class="card-accent-dark">
                        ...
                        <b-row class="mb-2">
                            <b-col sm="4">
                                    <b-button v-if="checkRights('13-50')" variant="success" @click="$refs.userentry.showModalEntry = true, $refs.userentry.entryMode='Add', $refs.userentry.clearFields('user')">
                            ...
                            <b-col sm="12">
                                ...
                                >
                                    <template v-slot:cell(action)="data" >
                                        <b-btn v-if="checkRights('13-51')" :size="'sm'" variant="primary" @click="$refs.userentry.setUpdate(data)">
                                            <i class="fa fa-edit"></i>
                                        </b-btn>

                                        <b-btn v-if="checkRights('13-52')" :size="'sm'" variant="danger" @click="$refs.deleteentry.setDelete(data.item.id)">
    ...
    computed: {
        checkAction(){
            if(this.$store.state.rights.length > 0){
                if((this.checkRights('13-51') || this.checkRights('13-52')) == false){
