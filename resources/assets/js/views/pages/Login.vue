...
<template>
  ...
  <div>
    ...
    <img class="d-block img-fluid bg" src="uploads/logo/bg.jpg" width="100%" height="100%" alt="First slide">
    <div class="box">
      
        <center>
          <img class="abc_logo" src="uploads/logo/ssl-lock.png">
        </center>   
        <h2>AB&C Login</h2>
        ...
        <form @submit.prevent="authLogin()" @input="login.success = null">
            ...
            <b-btn :disabled="login.is_saving" type="submit" class="float-right" variant="success" block>
                <icon v-if="login.is_saving" name="sync" spin></icon>
                Login
            </b-btn>
        </form>
