            ...
            <b-row>
                <b-col sm="12">
                    <b-card class="card-accent-dark">
                        ...
                        <b-row class="mb-2">
                            <b-col sm="4">
                                    <b-button v-if="checkRights('3-10')" variant="success" @click="$refs.categoryentry.showModalEntry = true, $refs.categoryentry.entryMode='Add', $refs.categoryentry.clearFields('category')">
                            ...
                            <b-col sm="12">
                                ...
                                >
                                    <template v-slot:cell(action)="data">
                                        <b-btn v-if="checkRights('3-11')" :size="'sm'" variant="primary" @click="$refs.categoryentry.setUpdate(data)">
                                            <i class="fa fa-edit"></i>
                                        </b-btn>

                                        <b-btn v-if="checkRights('3-12')" :size="'sm'" variant="danger" @click="$refs.deleteentry.setDelete(data.item.category_id)">
