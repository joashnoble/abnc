            ...
            <b-row>
                <b-col sm="12">
                    <b-card class="card-accent-dark">
                        ...
                        <b-row class="mb-2">
                            <b-col sm="4">
                                    <b-button v-if="checkRights('2-6')" variant="success" @click="$refs.servicetypeentry.showModalEntry = true, $refs.servicetypeentry.entryMode='Add', $refs.servicetypeentry.clearFields('servicetype')">
                            ...
                            <b-col sm="12">
                                ...
                                >
                                    <template v-slot:cell(action)="data">
                                        <b-btn v-if="checkRights('2-7')" :size="'sm'" variant="primary" @click="$refs.servicetypeentry.setUpdate(data)">
                                            <i class="fa fa-edit"></i>
                                        </b-btn>

                                        <b-btn v-if="checkRights('2-8')" :size="'sm'" variant="danger" @click="$refs.deleteentry.setDelete(data.item.service_type_id)">
